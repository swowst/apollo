...
<?php require_once "./admin/functions/helper.php"?>
...
<g transform="translate(0.000000,749.000000) scale(0.100000,-0.100000)">
    ...
    <div class="wrapper">
        <div class="camera"><img src="<?=  getImage($section2['image']) ?>" alt=""></div>
        <div class="blurb">
...
<g transform="translate(0.000000,749.000000) scale(0.100000,-0.100000)">
    ...
    <div class="wrapper">
        ...
        <div class="featured"><img src="<?= getImage($section3['image']) ?>" alt=""></div>
    </div>
</section>
...
<g transform="translate(0.000000,750.000000) scale(0.100000,-0.100000)">
    ...
    <div class="wrapper">
        ...
        <form method="POST" action="../apollo/admin/functions/section_4_form.php">
